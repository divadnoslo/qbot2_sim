...
if (r_flag == true)
    ...
    title('r^t__t_b_,_x   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Position (m)')
    grid on
    ...
    title('r^t__t_b_,_y   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Position (m)')
    grid on
    ...
    title('r^t__t_b_,_z   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Position (m)')
    grid on
...
if (v_flag == true)
    ...
    title('v^t__t_b_,_x   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Velocity (m/s)')
    grid on
    ...
    title('v^t__t_b_,_y   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Velocity (m/s)')
    grid on
    ...
    title('v^t__t_b_,_z   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Velocity (m/s)')
    grid on
...
if (a_flag == true)
    ...
    title('psi^t__t_b_,_phi   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Roll (\circ)')
    grid on
    ...
    title('psi^t__t_b_,_theta   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Pitch (\circ)')
    grid on
    legend('estimate', 'truth', 'Location', 'Best')
    subplot(3, 1, 3)
    plot(t, out.psi_t__t_b_est.Data(:,3) * 180/pi, 'b', t, rpy(3,:) * 180/pi, 'k')
    title('psi^t__t_b_,_psi   Truth vs. Estimate')
    xlabel('Time (s)')
    xlim([0 t(end)])
    ylabel('Yaw (\circ)')
    grid on
